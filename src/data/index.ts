...
import type { formInputs } from "../interfaces/index";
...
export const prodList: Product[] = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.pexels.com/photos/1289943/pexels-photo-1289943.jpeg",
    price: "$35",
    colors: ["red", "blue", "green"],
    category: {
      name: "Bags",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.pexels.com/photos/267606/pexels-photo-267606.jpeg",
    price: "$300",
    colors: ["red", "blue", "green"],
    category: {
      name: "Electronics",
  ...
  },
  {
    ...
    imageUrl:
      "https://images.pexels.com/photos/336917/pexels-photo-336917.jpeg",
    price: "$150",
    colors: ["red", "blue", "green"],
    category: {
      name: "Cameras",
